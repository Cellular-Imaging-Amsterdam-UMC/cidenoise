...
def report(localdata, output, frozen, models):
    ...
    review_link = '<p><a href="review.html">Local visual review notes</a></p>' if (reportdir / "review.html").is_file() else ""
...
<table><tr><th>Image</th><th>Model</th><th>Minutes</th><th>Peak GPU GiB</th></tr>''' + "".join(performance) + "</table>" + review_link + "<details><summary>Frozen calibration and settings</summary><pre>" + html.escape(json.dumps(frozen,indent=2)) + "</pre></details>" + "".join(sections), encoding="utf-8")
